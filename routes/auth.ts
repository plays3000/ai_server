...
import { RegisterDTO, LoginDTO, AuthResponse, User } from '../types/auth.js';
...
router.post('/login', async (req: Request<{}, {}, LoginDTO>, res: Response<AuthResponse>) => {
    try {
        ...
        const token = jwt.sign(
            ...
            authConfig.jwtSecret as string,  // ← as string 추가
            { expiresIn: authConfig.jwtExpiresIn } as jwt.SignOptions  // ← as jwt.SignOptions 추가
        );
